...
PROMPT_PRESETS = {
    ...
    "Technical Expert": (
        "Act as a technical expert for CT service reports; summarize the following report in clear, "
        "human-readable English structured as: 1) Summary of Issue, 2) Timeline with Key Actions, "
        "3) Technical Details, 4) Correspondence, 5) Final Outcome; keep all log entries exactly as written "
        "(1:1, no edits) and do not expand or interpret any abbreviations."
    ),
}
